...
class RestaurantRecommendationSystem:
    ...
    def create_restaurant_question(self):
        ...
        self.food_types = {
            ...
            "중식": IntVar(value=1), "육류": IntVar(value=1), "아시안음식": IntVar(value=1), "샐러드": IntVar(value=1)
        }
        ...
        self.restaurant_preferences = {
            "맛": IntVar(), "특별한 메뉴": IntVar(), "메뉴 다양성": IntVar(),
            "신선도": IntVar(), "가성비": IntVar(), "서비스": IntVar(),
            "청결": IntVar(), "혼밥": IntVar()
        }
    ...
    def create_cafe_question(self):
        ...
        self.cafe_preferences = {
            "커피": IntVar(), "디저트": IntVar(),
            "청결": IntVar(), "서비스": IntVar(), "분위기": IntVar(),
            "공부하기 좋음": IntVar()
        }
    ...
    def create_pub_question(self):
        ...
        self.pub_preferences = {
            "맛": IntVar(), "서비스": IntVar(), "다양한 술": IntVar(),
            "대화하기 좋음": IntVar(), "분위기기": IntVar()
        }
